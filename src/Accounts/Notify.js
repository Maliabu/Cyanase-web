...
const Notify = () => {
    return ( < div > < Pic / > < div className = "p-2 text-center shadow-sm rounded-4" >
        <
        p className = "pt-5 mt-5 bolder" > Notifications < /p> < /
        div > < div className = "p-3 bg-light rounded-4" > <
        div className = " mt-2 res-home" >
        <
        p className = "grey-text mx-2 bolder" > January 2023 < /p> <
