...
const FAQs = (props) => {
    ...
    return ( <
        ...
        <
        h4 > How do i withdraw my money ? < /h4> <
        ...
        className = "border rounded-4 border-warning text-warning p-3 w-25 text-center mt-5" > Ask a Question < /h6>  <
        Modal show = { show }
        onHide = { handleClose } >
        <
        Ask / > < /
