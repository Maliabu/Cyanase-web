...
class ResGoal extends React.Component {
    ...
    submitButton() {
            ...
            if (currentStep === 7) {
                return ( 
                    <h6 className = "bg-warning rounded-3 text-center p-2 mx-5"
                    id = "alert"
                    onClick = {
                        () => { this.returnToGoals() }
                    } > Create this goal </h6> )
...
function Step1(props) {
    ...
    return ( 
        ...
        function Step2(props) {
            ...
            return ( 
                <div className = "text-center p-3 bolder" >
                ...
                This field is required. </Form.Control.Feedback> 
                </Form.Group>
                <Form.Group className = "mb-3 bg-white rounded-4 p-3 px-5" >
        ...
        function Step3(props) {
            ...
            return ( 
                <div className = "text-center px-3 mb-3 bolder" > 
                <p className = "mt-3" > How much will it cost to accomplish this Goal ? How much do you have to keep depositing(
                ...
                <span className = "active font-lighter" > { props.deposit_amount } </span>  
                </h6> </div>
                </div>
            );
        }
