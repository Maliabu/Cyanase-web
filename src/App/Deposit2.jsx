...
const Deposit2 = ({ id, activeTab, children, ...props }) => {
    ...
    return ( 
        ...
        <h6 className = " btn btn-warning mt-4 text-center"
        ...
        <div className = "text-start col-6 mt-3" > 
        <h6> PROCEDURE </h6> </div> 
        </div>
        <div className = "p-2" > 
        <div className = "row px-3 bg-white rounded-4" >
        <div className = "col-2" >
        <p className = "py-2 px-3 mt-3 rounded-circle text-center bg-lighter" > 1 </p>
        </div>
        <div className = "col-10" >
        <h6 className = " pt-4" > Fill in your Risk Profile </h6></div> </div>  
        <div className = "row px-3 bg-white mt-2 rounded-4" >
        <div className = "col-2" >
        <p className = "py-2 px-3 mt-3 rounded-circle text-center bg-lighter" > 2 </p>
        </div>
        <div className = "col-10" >
        ...
        <div className = "row px-3 bg-white mt-2 rounded-4" >
        <div className = "col-2" >
        <p className = "py-2 mt-3 px-3 rounded-circle text-center bg-lighter" > 3 </p>
        </div>
        <div className = "col-10">
        ...
        <h6 className = "text-center mt-3 btn btn-warning"
