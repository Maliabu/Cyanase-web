  ...
  return (
    <div className="scroll-y">
      ...
      <div className="row mt-3 p-2 px-3 border-bottom">
        {" "}
        <div className="col-1">
          <User size="large" set="broken" className="my-5 my-lg-3 active" />
        </div>
        <div className="col-11 mt-5 mt-lg-3">
          <h4
      ...
      <div className="row mt-3 p-2 px-3 border-bottom">
        {" "}
        <div className="col-1">
          <Chat size="large" set="broken" className="my-5 my-lg-3 active" />
        </div>
        <div className="col-11 mt-5 mt-lg-3">
          <h4
            className="active bolder"
      ...
      <div className="row mt-3 p-2 px-3 border-bottom">
        {" "}
        <div className="col-1">
          <Call size="large" set="broken" className="my-5 my-lg-3 active" />
        </div>
        <div className="col-11 mt-5 mt-lg-3">
          <h4
            className="active bolder"
