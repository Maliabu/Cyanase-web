...
export const API_URL_GET_INVESTMENT_CLASSES = "http://"+server+"/api/v1/en/auth/get/investment/classes/";
export const API_URL_GET_INVESTMENT_OPTIONS = "http://"+server+"/api/v1/en/auth/get/investment/options/";
export const API_URL_GET_INVESTMENT_CLASS_OPTIONS = "http://"+server+"/api/v1/en/auth/get/investment/class/options/";
...
export const API_EMAIL_VERIFY = "http://"+server+"/api/v1/en/get/user/verification/";
export const API_RESEND_VERIFICATION_EMAIL = "http://"+server+"/api/v1/en/resend/verification/email/";
export const API_URL_USER_PROFILE_PHOTO = "http://"+server+"/api/v1/en/auth/user/upload/profile/photo/";
export const API_URL_GOAL_PHOTO = "http://"+server+"/api/v1/en/auth/upload/goal/photo/";
...
export const API_URL_GET_USER_VERIFICATION = "http://"+server+"/api/v1/en/get/verification/";
...
export const GOAL_PHOTO = "http://"+server+"/media/goal/default_picture.jpg";
export const API_URL_GET_INVESTMENT_WITHDRAWS = " http://"+server+"/api/v1/en/get/investment/withdraws/";
export const API_URL_GET_USER_TRACK = " http://"+server+"/api/v1/en/get/user/track/";
...
export const apiDocs = "http://developers.cyanase.app";
